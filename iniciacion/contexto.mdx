...
<Steps>
  <Step title="Preparar la información base." stepNumber={1} titleSize="h2">
    ## 
  ...
  <Step title="Elaborar el prompt para la IA." stepNumber={2} titleSize="h2">
  ...
  <Step title="Revisión crítica" stepNumber={3} titleSize="h2">
  ...
  <Step title="Re-Prompt" stepNumber={4} titleSize="h2">
