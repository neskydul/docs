...
<Steps>
  <Step title="Preparar la información base." titleSize="h2">
    ## 
  ...
  <Step title="Elaborar el prompt para la IA." titleSize="h2">
  ...
  <Step title="Revisión crítica" titleSize="h2">
  ...
  <Step title="Re-Prompt" titleSize="h2">
