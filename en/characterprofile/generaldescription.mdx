...
<Steps>
  <Step title="Extraction of Historical Data">
    ...
    <Tip>
      Technical instructions for obtaining Historical Data [here](/en/characterprofile/historicaldata)
    </Tip>
  ...
  <Step title="Generation of Historical Context">
    ...
    <Tip>
      Technical instructions for generating the Historical Context [here](/en/characterprofile/historicalcontext)
    </Tip>
  ...
  <Step title="Creation of Character Profile">
    ...
    <Tip>
      Technical instructions for creating the Character Profile [here](/en/characterprofile/characterprofile)
    </Tip>
  ...
  <Step title="Creation of Personal Narrative">
    ...
    <Tip>
      Technical instructions for creating the Narrative [here](/en/characterprofile/narrative)
    </Tip>
    Finally:
...
<Note>
  ...
  - Access the Error Table template [here](/en/characterprofile/resources#tabla-de-errores)
</Note>
