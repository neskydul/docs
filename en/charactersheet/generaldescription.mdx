...
<Steps>
  <Step title="Extraction of Historical Data">
    ...
    <Tip>
      Technical instructions for obtaining Historical Data [here](/en/charactersheet/historicaldata)
    </Tip>
    ...
    - **Format:** The data should be filled in a **historical data table**.
  ...
  <Step title="Generation of Historical Context">
    ...
    <Tip>
      Technical instructions for generating the Historical Context [here](/en/charactersheet/historicalcontext)
    </Tip>
  ...
  <Step title="Creation of Character Profile">
    ...
    <Tip>
      Technical instructions for creating the Character Profile [here](/en/charactersheet/characterprofile)
    </Tip>
  ...
  <Step title="Creation of Personal Narrative">
    ...
    <Tip>
      Technical instructions for creating the Narrative [here](/en/charactersheet/narrative)
    </Tip>
    Finally:
...
<Note>
  ...
  - Access the Error Table template [here](/en/charactersheet/resources#error-table)
</Note>