...
<Steps>
  <Step title="Preparar la información base." icon="book-open-cover" stepNumber={1} titleSize="h2">
    <Tabs>
  ...
  <Step title="Elaborar el prompt para la IA." icon="sparkles" stepNumber="2" titleSize="h2">
  ...
  <Step title="Revisión crítica" icon="sparkles" stepNumber="3" titleSize="h2">
  ...
  <Step title="Re-Prompt" icon="sparkles" stepNumber="4" titleSize="h2">
