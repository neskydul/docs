...
<Steps>
  <Step title="Preparar la información base." iconType="duotone" stepNumber="1" titleSize="h2">
    <Tabs>
      <Tab title="Instrucciones">
        A partir de los datos que el alumno haya recopilado en su tabla de [Datos Históricos](/es/fichadepersonaje/datos), se construirá un pequeño listado.
  ...
  <Step title="Contexto Histórico Final" icon="newspaper" iconType="duotone" titleSize="h2">
    Los alumnos añadirán el contexto histórico final a la Ficha de Personaje.
...
<Note>
  Una vez completado el contexto histórico, el siguiente paso es la [creación del perfil de personaje](/es/fichadepersonaje/perfil).
</Note>
